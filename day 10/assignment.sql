...
-- insert into Policy values (5,103, 'Vehicle', 1500, 301); -- not executed
-- insert into Policy values (6, 103, 'Life', 6000, 301); -- not executed
...
select BranchID, min(PremiumAmount) as MIN_AMT from Policy
group by BranchID;
